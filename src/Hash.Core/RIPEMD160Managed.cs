...
// MIT License
// https://github.com/microsoft/referencesource/blob/51cf7850defa8a17d815b4700b67116e3fa283c2/LICENSE.txt
// 
// See NOTICE.md for the full license text.

//
// RIPEMD160Managed.cs
// https://github.com/microsoft/referencesource/blob/51cf7850defa8a17d815b4700b67116e3fa283c2/mscorlib/system/security/cryptography/ripemd160managed.cs
//
    ...
    public class RIPEMD160Managed : HashAlgorithm
    {
        ...
        private void _HashData(byte[] partIn, int ibStart, int cbSize) {
            ...
            if ((bufferLen > 0) && (bufferLen + partInLen >= 64)) {
                ...
                MDTransform(_blockDWords, _stateMD160, _buffer);
                bufferLen = 0;
            }
